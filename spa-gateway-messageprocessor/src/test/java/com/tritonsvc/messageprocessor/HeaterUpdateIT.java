...
public class HeaterUpdateIT {

    private static final Logger log = LoggerFactory.getLogger(HeaterUpdateIT.class);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    IOUtils.copy(HeaterUpdateIT.class.getResourceAsStream("/agent-config.properties"), new FileOutputStream(new File(agentFolder, "config.properties")));
