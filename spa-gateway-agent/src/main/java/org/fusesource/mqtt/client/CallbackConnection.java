...
// This is a temporary override due to a bug in main lib, the patch should be merged soon
// and this override class should be removed once fix is in master:
//
// https://github.com/fusesource/mqtt-client/pull/62
